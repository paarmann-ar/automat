...
class ReviewAndProcessCollectionLettersStandardView(BaseChapter, StandardView):
    def __init__(
        self,
        *args,
        **kwargs,
    ...
    def __prepare(
        self,
        customer_account=("D13900000003",True),
    ) -> bool:
        ...
        try:
            ...
            self.search_item = customer_account
    ...
    @BaseChapter.log
    def select_customer_account(self, **kwargs) -> bool:
