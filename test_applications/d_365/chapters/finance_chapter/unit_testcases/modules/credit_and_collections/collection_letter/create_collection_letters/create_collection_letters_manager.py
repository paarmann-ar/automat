...
class CreateCollectionLettersManager(BaseChapter, Page):
    ...
    def __setup(self) -> bool:
        ...
        try:
            ...
            self.tab_records_to_include = TabRecordsToInclude()
    ...
    @BaseChapter.wait_for(
        element_for_waiting_until_visible="frm_create_collection_letters_manager",
        type_of_element="text_to_search",
    )
    @BaseChapter.log
    def create_collection_letters_manager(self, **kwargs) -> bool:
