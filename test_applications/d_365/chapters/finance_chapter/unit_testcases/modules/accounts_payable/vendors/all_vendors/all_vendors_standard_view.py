...
class AllVendorsStandardView(BaseChapter, StandardView):
    def __init__(
        self,
        *args,
        **kwargs,
    ...
    def __prepare(
        ...
        try:
            ...
            self.search_item_text = item_text
    ...
    @BaseChapter.wait_for(
        element_for_waiting_until_visible="frm_all_vendors_standard_view",
        type_of_element="text_to_search",
    )
    @BaseChapter.log
    def select_vendor(self, **kwargs) -> bool:
