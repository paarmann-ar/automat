...
class PendingVendorInvoicesTopGadget(BaseChapter, Page):
    ...
    @BaseChapter.log
    def new_pending_vendor_invoices(self) -> bool:
    ...
    @BaseChapter.log
    def save_pending_vendor_invoices(self) -> bool:
    ...
    @BaseChapter.log
    def delete_pending_vendor_invoices(self) -> bool:
    ...
    @BaseChapter.log
    def edit_pending_vendor_invoices(self) -> bool:
    ...
    @BaseChapter.log
    def post_pending_vendor_invoices(self) -> bool:

        try:

            self.click_button(self.elements.btn_post)
            self.delay(220)
