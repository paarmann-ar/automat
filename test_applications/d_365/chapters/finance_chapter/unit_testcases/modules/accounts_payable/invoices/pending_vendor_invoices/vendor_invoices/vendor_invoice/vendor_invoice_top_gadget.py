...
class VendorInvoiceTopGadget(BaseChapter, Page):
    ...
    @BaseChapter.log
    def new_vendor_invoice(self) -> bool:
    ...
    @BaseChapter.log
    def save_vendor_invoice(self) -> bool:
    ...
    @BaseChapter.log
    def delete_vendor_invoice(self) -> bool:
    ...
    @BaseChapter.log
    def edit_vendor_invoice(self) -> bool:
    ...
    @BaseChapter.log
    def attachments_vendor_invoice(self) -> bool:

        try:

            self.click_button(self.elements.btn_attachments)
    ...
    @BaseChapter.log
    def workflow_vendor_invoice(self) -> bool:
