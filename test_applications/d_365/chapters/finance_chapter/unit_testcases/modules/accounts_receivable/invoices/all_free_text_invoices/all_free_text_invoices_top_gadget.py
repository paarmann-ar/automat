...
class AllFreeTextInvoicesTopGadget(BaseChapter, Page):
    ...
    @BaseChapter.log
    def edit_free_text_invoice(self) -> bool:
    ...
    @BaseChapter.log
    def new_free_text_invoice(self) -> bool:
    ...
    @BaseChapter.log
    def save_free_text_invoice(self) -> bool:
    ...
    @BaseChapter.log
    def delete_free_text_invoice(self) -> bool:
