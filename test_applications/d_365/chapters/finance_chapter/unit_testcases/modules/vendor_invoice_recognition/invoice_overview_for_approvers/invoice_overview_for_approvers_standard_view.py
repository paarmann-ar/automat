...
# ...
# --
class InvoiceOverviewForApproversStandardView(BaseChapter, StandardView):
    def __init__(
        self,
        *args,
        **kwargs,
    ...
    def __prepare(
        self,
        vendor_invoice_number=("V139100004",True),
    ) -> bool:
        ...
        try:
            ...
            self.search_item = vendor_invoice_number
    ...
    @BaseChapter.log
    def select_number(self, **kwargs) -> bool:
