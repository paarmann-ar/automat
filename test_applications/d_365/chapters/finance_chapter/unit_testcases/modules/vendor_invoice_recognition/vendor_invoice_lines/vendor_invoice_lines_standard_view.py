...
class VendorInvoiceLinesStandardView(BaseChapter, StandardView):
    def __init__(
        self,
        *args,
        **kwargs,
    ...
    def __prepare(
        self,
        pending_invoice_lines_number=("V139100004",True),
    ) -> bool:
        ...
        try:
            ...
            self.search_item = pending_invoice_lines_number
    ...
    @BaseChapter.log
    def select_pending_invoice_lines(self, **kwargs) -> bool:
