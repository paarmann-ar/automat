...
class InboundMqInterfaceDataStandardView(BaseChapter, StandardView):
    def __init__(
        self,
        *args,
        **kwargs,
    ...
    def __prepare(
        self,
        incoming_message_id=("DIC11000", True),
    ) -> bool:
    ...
    @BaseChapter.wait_for(
        element_for_waiting_until_visible="frm_inbound_mq_interface_data",
        type_of_element="text_to_search",
    )
    @BaseChapter.log
    def select_incoming_message_id(self, **kwargs) -> bool:
